...
export function InventoryScreen() {
  const { navigate, state, setState, addSavings: addSavingsAction } = useJourney();
  ...
  const handleAddSavings = () => {
    ...
    const result = addSavingsAction(amt);
    setSavingsAmt("");
    if (result.demonTriggered) {
      navigate("world");
    }
  };
          ...
          <>
            ...
            <RpgPanel>
              ...
              <div className="flex gap-2">
                ...
                <RpgButton variant="primary" onClick={handleAddSavings} style={{ fontSize: 6, whiteSpace: "nowrap" }}>SAVE</RpgButton>
              </div>
            </RpgPanel>
          </>
        )}
